...
public sealed partial class LeptonicaApi_Imports
{
    ...
    internal static extern IntPtr PixRotate(HandleRef handle, float angleInRadians, int method, int fillColor, int value1, int value2);
    ...
    internal static extern int PixWrite(string filename, HandleRef handle, int actualFormat);

    [LibraryImport(DllName, EntryPoint = "selCreateBrick")]
    [UnmanagedCallConv(CallConvs = new Type[] { typeof(System.Runtime.CompilerServices.CallConvCdecl) })]
    internal static partial IntPtr SelCreateBrick(int selSize1, int selSize2, int v1, int v2, int type);
